...
export const FAQS_TEXT = [
   {
      q: "What is the Zap Protocol?",
      a: [
         "The Zap Protocol is a decentralized bonding curve curation market providing access to data providers and other " +
            "services through algorithmic token generation. ",
         "The protocol provides developers numerous templates to easily build their " +
            "decentralized applications (dapps). As well, oracles listed on the market can provide the valuable data needed for dapps " +
            "either built on the Zap protocol or on another blockchain ecosystem to function. ",
      ],
   },
   {
      q: "What is an Oracle?",
      a: [
         " An oracle is the means by which off-chain information can be fed into a smart contract or another decentralized application. " +
            "They are a necessity for the functionality of decentralized products which are dependent on off-chain data. Oracles are capable of " +
            "actuating autonomous economic activity on the blockchain. ",
      ],
   },
   {
   ...
   },
   {
      ...
      a: [
         ...
         "This following is a simple example of a x^2 bonding curve.",
      ],
      extra: (
         <img
            alt="Example of an x^2 bonding curve with some pool balance and token supply"
            src="/static/images/x2example.png"
            style={{ display: "block", width: "85%", margin: "auto" }}
         />
      ),
   },
   {
   ...
   {
      q: "What are some use cases?",
      a: [
         "Here is a few of the use cases possible using the Zap protocol: ",
         "Data (oracle) monetization, Issue a new ERC20, Create a DAO, Decentralized Competitions, Fundraising, Development Bounties, " +
            "Tokenization of Property, Tradable Futures Market, Zap Wrapped Token",
      ],
   },
   {
      q: "What are some partnerships?",
      a: [
         "As of July 2020, Zap has officially announced partnerships with the following companies and projects:",
         "CoinGecko, Cafe Joe USA, BitUnits, Howdoo, Energy Ledger, and JuJu Rental",
         "Many are in the works and in the process of becoming official. Check back for an updated list.",
      ],
   },
   {
      q: "What Blockchain does Zap Operate on?",
      a: [
   ...
   {
      q: "How is Zap different from other projects?",
      a: [
   ...
   {
      q: "Where can I keep up to date with the project?",
      a: ["These are the official links for the Zap protocol:"],
      extra: SOCIAL("10px").map((entry) => (
   ...
   {
      q: "How do I access the Zap protocol?",
      a: ["You can access through the following portal link:"],
      extra: (
         <Typography color={"primary"} variant="body2">
            <Link
               target={"_blank"}
   ...
   {
      q: "What is the difference between Chainlink & Zap?",
      a: [
         "[Copy of Ben Gravis' answer from the official Discord]:",
         "Zap's token has utility unlike chainlink. Zap is an ecosystem for companies, " +
