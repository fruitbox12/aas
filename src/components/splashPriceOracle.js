...
const SplashPriceOracles = (props) => {
  ...
  let thumbnailParams = {
    ...
    axesOptions: window.screen.width > 650 ? { xAxisTicks: 2, yAxisTicks: 2, showLabels: true } : { xAxisTicks: 1, yAxisTicks: 1, showLabels: false },
    zoomFit: 1.2,
  };
...
export default withWidth()(SplashPriceOracles);
