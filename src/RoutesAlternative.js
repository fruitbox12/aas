                     ...
                     <Suspense fallback={<LoadingScreen />}>
                        <Switch>
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/reports/DashboardAlternativeView"
                                 )
                              )}
                           />
                           <Redirect
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/management/CustomerDetailsView"
                                 )
                              )}
                           />
                           <Route
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/management/ProductCreateView"
                                 )
                              )}
                           />
                           <Route
                              ...
                              component={lazy(() =>
                                 import("src/views/management/OrderListView")
                              )}
                           />
                           <Route
                              exact
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/management/InvoiceDetailsView"
                                 )
                              )}
                           />
                           <Route
                              ...
                              path="/app/calendar"
                              component={lazy(() =>
                                 import("src/views/calendar/CalendarView")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/endpointwizard/EndPointWizardView"
                                 )
                              )}
                           />
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/oraclemarket/OracleMarketView"
                                 )
                              )}
                           />
                           <Route
                              ...
                              component={lazy(() =>
                                 import("src/views/tokenmarket/TokenMarketView")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import("src/views/providerprofile/index.js")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import("src/views/bondwizard/index.js")
                              )}
                           />
                           <Route
                              exact
                              path="/app/kanban"
                              component={lazy(() =>
                                 import("src/views/kanban/KanbanView")
                              )}
                           />
                           <Route
                              path={["/app/chat/new", "/app/chat/:threadKey"]}
                              component={lazy(() =>
                                 import("src/views/chat/ChatView")
                              )}
                           />
                           <Route
                              path={[
                              ...
                              component={lazy(() =>
                                 import("src/views/mail/MailView")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import("src/views/projects/OverviewView")
                              )}
                           />
                           <Route
                              exact
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import("src/views/social/FeedView")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import("src/views/social/ProfileView")
                              )}
                           />
                           <Route
                              exact
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import("src/views/extra/forms/FormikView")
                              )}
                           />
                           <Route
                              exact
                           ...
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/extra/editors/DraftEditorView"
                                 )
                              )}
                           />
                           <Route
                              ...
                              component={lazy(() =>
                                 import(
                                    "src/views/extra/editors/QuillEditorView"
                                 )
                              )}
                           />
                           <Redirect to="/404" />
                     ...
                     <Suspense fallback={<LoadingScreen />}>
                        <Switch>
                           ...
                           <Route
                              ...
                              path="/docs/welcome"
                              component={lazy(() =>
                                 import("src/views/docs/WelcomeView")
                              )}
                           />
                           <Route
                              exact
                              ...
                              component={lazy(() =>
                                 import("src/views/docs/whitepaper")
                              )}
                           />
                           <Redirect to="/404" />
                        </Switch>
                  ...
                  <MainLayout {...props}>
                     <Switch>
                        ...
                        <Route
                           ...
                           path="/pricing"
                           component={lazy(() =>
                              import("src/views/pages/PricingView")
                           )}
                        />
                        <Redirect to="/404" />
                     </Switch>
