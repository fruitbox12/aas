<!--- endptwizardpage.stories.mdx -->

import { Meta, Story, Canvas } from "@storybook/addon-docs/blocks";
import EndpointWizardView from "../../../views/endpointwizard/index.js";

<Meta title="MDX/Endpoint Wizard" component={EndpointWizardView} />
...
This is page the user goes to for listing a new oracle for the ZAP marketpalce.
