...
export const bondageAbi = [
   ...
   },
   {
      ...
      name: "bond",
      outputs: [{ name: "bound", type: "uint256" }],
      payable: false,
      stateMutability: "nonpayable",
      type: "function",
   },
   ...
   },
   {
      ...
      name: "unbond",
      outputs: [{ name: "unbound", type: "uint256" }],
      payable: false,
      stateMutability: "nonpayable",
      type: "function",
   },
   {
      ...
      name: "calcZapForDots",
      outputs: [{ name: "numZap", type: "uint256" }],
      payable: false,
      stateMutability: "view",
      type: "function",
   },
   ...
   },
   {
      ...
      name: "delegateBond",
      outputs: [{ name: "boundZap", type: "uint256" }],
      payable: false,
      stateMutability: "nonpayable",
      type: "function",
   },
   ...
   {
      constant: true,
      inputs: [{ name: "holderAddress", type: "address" }],
      name: "getIndexSize",
      outputs: [{ name: "", type: "uint256" }],
      payable: false,
      stateMutability: "view",
   ...
   },
   {
      ...
      inputs: [
         ...
         { indexed: true, name: "endpoint", type: "bytes32" },
         { indexed: false, name: "numZap", type: "uint256" },
         { indexed: false, name: "numDots", type: "uint256" },
      ],
      name: "Bound",
      type: "event",
   },
