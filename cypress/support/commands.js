...
export const TEST_ADDRESS_NEVER_USE = '0x93d24FF767a74B1Ceec47F23495edC4195d3081A'

export const TEST_ADDRESS_NEVER_USE_SHORTENED = '0x93d2...081A'
...
Cypress.Commands.overwrite('visit', (original, url, options) => {
  return original(url.startsWith('/') && url.length > 2 && !url.startsWith('/#') ? `/#${url}` : url, {
    ...
    onBeforeLoad(win) {
      ...
      const provider = new JsonRpcProvider('https://kovan.infura.io/v3/fadcf8b8c33940c9a4d932361dffee35', network)
